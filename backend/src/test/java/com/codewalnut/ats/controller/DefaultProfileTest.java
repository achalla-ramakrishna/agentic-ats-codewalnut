...
/** Without an explicit profile (i.e. a production-like start) the dev login must not exist (AUTH-14). */
...
class DefaultProfileTest {
    ...
    @Test
    void devLoginIsAbsentWithoutTheDevProfile() throws Exception {
